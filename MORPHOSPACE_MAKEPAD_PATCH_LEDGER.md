...
4. Platform/video watchlist:
   ...
   - `platform/src/os/linux/vulkan.rs`: root basic storage/u32/f32 probe code is
     ...
     offscreen target, and geometry orchestration unless HWB/video-import work
     or a narrow proof-program/resource-lifetime slice forces a clear
