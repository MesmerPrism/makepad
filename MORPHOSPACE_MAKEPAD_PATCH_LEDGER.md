...
4. Platform/video watchlist:
  ...
  - `platform/src/os/linux/vulkan.rs`: root basic storage/u32/f32 probe code is
    ...
    `platform/src/os/linux/vulkan/openxr_targets.rs`, and texture/image
    ...
    draw-list, pipeline, and geometry orchestration unless HWB/video-import
