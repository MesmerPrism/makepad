...
4. Platform/video watchlist:
   ...
   - `platform/src/os/linux/vulkan.rs`: root basic storage/u32/f32 probe code is
     now split to `platform/src/os/linux/vulkan/basic_compute_probe.rs`. Leave
     the root file alone unless HWB/video-import work or a narrow
     proof-program/resource-lifetime slice forces a clear resource-lifetime,
     command-buffer, or descriptor boundary with a GPU validation gate. Video
     import/lifetime work should start in
