# Makepad Script DSL Guide

Use this guide when editing Makepad script_mod!, widgets, shaders, app structure, or script DSL syntax in this fork.

## Contents

- Syntax conversion rules
- UI runnable execution policy
- Cargo.toml setup
- Widgets DSL patterns
- Widget, shader, animator, PortalList, FileTree, and template examples
- Multi-module script registration
- Common pitfalls
