...
pub trait CxOsApi {
    ...
    fn xr_gpu_f32_skinning_probe(
        &mut self,
        _samples: [XrGpuF32SkinningProbeSample; XR_GPU_F32_SKINNING_PROBE_SAMPLES],
        _sample_count: usize,
        _tolerance: f32,
    ...
    fn xr_gpu_f32_mesh_sdf_probe_submit(
        &mut self,
        _vertices: &[XrGpuF32SkinningMeshVertex],
        _triangles: &[XrGpuSkinningMeshTriangle],
        _grid: XrGpuF32MeshSdfProbeGrid,
        ...
        _sample_count: usize,
        _tolerance: f32,
    ) -> Option<XrGpuF32MeshSdfProbeTicket> {
        None
    }

    fn xr_gpu_f32_mesh_sdf_probe_poll(
        &mut self,
        _request_id: u64,
    ) -> Option<XrGpuF32MeshSdfProbeResult> {
        None
...
pub const XR_GPU_F32_SKINNING_PROBE_SAMPLES: usize = 4;
...
#[derive(Clone, Copy, Debug, Default, PartialEq)]
pub struct XrGpuF32SkinningProbeResult {
    pub samples: [XrGpuF32SkinningProbeSample; XR_GPU_F32_SKINNING_PROBE_SAMPLES],
    pub output_positions: [[f32; 4]; XR_GPU_F32_SKINNING_PROBE_SAMPLES],
    pub expected_positions: [[f32; 4]; XR_GPU_F32_SKINNING_PROBE_SAMPLES],
    pub sample_count: usize,
    pub component_count: usize,
    pub mismatched_components: usize,
    pub max_abs_error: f32,
...
pub struct XrGpuF32SkinningProbeTicket {
    pub request_id: u64,
    pub queue_submit_serial: u64,
    pub resource_generation: u64,
    pub pending_retire_count: usize,
...
#[derive(Clone, Copy, Debug, Default, PartialEq, Eq)]
pub struct XrGpuF32MeshSdfProbeTicket {
    pub request_id: u64,
    pub queue_submit_serial: u64,
    pub resource_generation: u64,
    pub pending_retire_count: usize,
...
pub enum CxOsOp {
    ...
    ShowInDock(bool),
    /// Tints the Android status/navigation bar icons. `true` requests dark
    /// icons, `false` requests light icons.
...
impl Cx {
    ...
    pub fn xr_gpu_f32_skinning_probe(
        &mut self,
    ...
    pub fn xr_gpu_f32_skinning_probe_submit(
        &mut self,
        samples: [XrGpuF32SkinningProbeSample; XR_GPU_F32_SKINNING_PROBE_SAMPLES],
        sample_count: usize,
        tolerance: f32,
    ) -> Option<XrGpuF32SkinningProbeTicket> {
        <Self as CxOsApi>::xr_gpu_f32_skinning_probe_submit(self, samples, sample_count, tolerance)
    }

    pub fn xr_gpu_f32_skinning_probe_poll(
        &mut self,
        request_id: u64,
    ) -> Option<XrGpuF32SkinningProbeResult> {
        <Self as CxOsApi>::xr_gpu_f32_skinning_probe_poll(self, request_id)
    }
    ...
    pub fn xr_gpu_f32_mesh_sdf_probe_submit(
        &mut self,
        vertices: &[XrGpuF32SkinningMeshVertex],
        triangles: &[XrGpuSkinningMeshTriangle],
        grid: XrGpuF32MeshSdfProbeGrid,
        ...
        <Self as CxOsApi>::xr_gpu_f32_mesh_sdf_probe_submit(
            self,
            vertices,
            triangles,
            grid,
    ...
    pub fn xr_gpu_f32_mesh_sdf_probe_poll(
        &mut self,
        request_id: u64,
    ) -> Option<XrGpuF32MeshSdfProbeResult> {
    ...
    /// Controls the status/navigation bar icon tint on platforms that support
    /// it. `Auto` follows the window background luminance.
